...
\begin{exercises}
  ...
  \item Sort the \mycommand{countries} file based on its population (second column) in crescent order.
  \item Sort the \mycommand{countries} file based on its area (third column) in descent order.
